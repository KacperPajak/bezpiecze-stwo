...
{
//"keytool -list -keypass cebulka123 -storepass cebulka123";
    string buf = "keytool -list -keypass " + pass + " -storepass " + pass;
    if(exec(buf.c_str())[0] == 'K') {return true;} 
    else {return false;}
}
...
void generateKeys(int length)
{
    ...
    exec("keytool -delete -alias rsa2048 -storepass cebulka123 -keypass cebulka123 > log.txt");
    cout << exec("keytool -genkey -alias rsa2048 -keyalg RSA -keysize 2048 -storepass cebulka123 -dname 'CN=none,OU=none,O=none,L=none,S=none,C=none' -keypass cebulka123 > log.txt"); 
...
int main(int argc, char *argv[])
{
	...
	cout << "Wybierz rozmiar klucza: 1 - 2048, 2 - 4096, 3 - 8192, 4 - 16384:";
        ...
        cout << "Wygenerowano hasło: " << "cebulka123" << endl;
        return 0;
     }
     if(tryb == "service")
     {
