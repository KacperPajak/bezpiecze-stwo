...
if($result = $conn->query("SELECT * FROM trans ORDER BY ID DESC LIMIT 1;"));
$row = mysqli_fetch_assoc($result);
$max =  $row['ID']; 
foreach($_POST as $checkbox) {
if($conn->query("UPDATE trans SET veryfied = 1 WHERE ID = ".$max." - ".$checkbox.";"));
}
...
<div id="hist">
	<form action='admin.php'>
		...
		<input type="submit" id="trans-btn" value="back"/>
	</form>
</div>
	</body>
</html>
